...
import { createCategory, deleteCategory, getCategory, getCategories, validateCategory, categoryExists, updateCategory } from './categories.db.js';
import { editQuestion, createQuestion, deleteQuestion, getQuestion, getQuestions, getQuestionsByCategory, getAnswersByQuestionId, createAnswer, editAnswer, getAnswers, getAnswer, deleteAnswer, validateQuestion, validateAnswer } from './questions.db.js';
const app = new Hono();
app.get('/', (c) => {
